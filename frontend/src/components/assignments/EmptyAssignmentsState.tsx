...
export function EmptyAssignmentsState() {
  return (
    <div className="assignment-canvas relative flex-1 min-h-0 overflow-hidden bg-[var(--shell-bg)] px-2.5 pb-24 pt-2 sm:bg-[var(--shell-bg)] sm:px-3 sm:pb-3">
      <div className="relative flex h-full min-h-0 items-center justify-center overflow-hidden rounded-[20px] bg-[var(--shell-bg)]  px-4 py-8 sm:bg-[var(--shell-bg)] sm:px-6 sm:py-18">
        <div className="pointer-events-none absolute left-[22%] top-[27%] h-8 w-8 rotate-[-8deg] text-[#0f1f33] opacity-90 sm:left-[38.7%] sm:top-[30.5%]">
          <ScribbleIcon />
        </div>
        <div className="pointer-events-none absolute left-[31%] top-[49.5%] h-4.5 w-4.5 text-[#5a7eaa] opacity-85 sm:left-[43.3%] sm:top-[52%]">
          <SparkleOutlineIcon />
        </div>
        <div className="pointer-events-none absolute right-[20%] top-[44%] h-2.5 w-2.5 rounded-full bg-[#5579a7] opacity-90 sm:right-[37%] sm:top-[45.5%]" />

        <div className="relative z-10 flex max-w-[355px] flex-col items-center text-center">
          <EmptyStateGraphic />
          <h1 className="mt-3 text-[1.15rem] font-extrabold tracking-[-0.05em] text-[#302c29] sm:mt-4 sm:text-[1.05rem] sm:tracking-[-0.045em]">
            No assignments yet
          </h1>
          <p className="mt-3 max-w-[312px] text-[13px] leading-[1.5] text-[#8b837b] sm:mt-2 sm:max-w-[332px] sm:leading-[1.4]">
...
function EmptyStateGraphic() {
  return (
    <div className="relative h-[176px] w-[176px] sm:h-[208px] sm:w-[208px]">
      ...
      <div className="absolute left-[86px] top-[56px] h-[76px] w-[76px] rounded-full border-[6px] border-[#c9bed9] bg-[rgba(255,255,255,0.56)] shadow-[0_12px_30px_rgba(112,89,140,0.12)] sm:left-[100px] sm:top-[66px] sm:h-[90px] sm:w-[90px]" />
      <div className="absolute left-[138px] top-[118px] h-[14px] w-[36px] rotate-[47deg] rounded-full bg-[#d8cfe2] sm:left-[162px] sm:top-[135px] sm:h-[16px] sm:w-[42px]" />
      <div className="absolute left-[104px] top-[75px] grid h-[40px] w-[40px] place-items-center rounded-full bg-white/72 sm:left-[123px] sm:top-[89px] sm:h-[44px] sm:w-[44px]">
