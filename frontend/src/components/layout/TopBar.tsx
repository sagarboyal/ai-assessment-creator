...
export function TopBar() {
  return (
    <header className="px-2.5 pt-2.5">
      ...
      <div className="hidden items-center gap-3 rounded-2xl bg-white px-5 py-3 shadow-[0_10px_24px_rgba(28,21,14,0.08)] md:flex">
        ...
        <div className="min-w-0 text-[13px] font-medium text-[#97918a]">
          Assignment
        </div>
