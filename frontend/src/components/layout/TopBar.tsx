...
export function TopBar() {
  return (
    <header className="px-2.5 pt-2.5">
      <div className="flex items-center gap-3 rounded-2xl bg-white px-5 py-3 shadow-[0_10px_24px_rgba(28,21,14,0.08)]">
        <button className="grid h-7 w-7 place-items-center rounded-full text-[var(--text-strong)] transition hover:-translate-y-0.5">
        ...
        <div className="min-w-0 text-[13px] font-medium text-[#97918a]">Assignment</div>
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 rounded-full bg-[#fbfaf8] py-1 pl-1 pr-3 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.78)] transition hover:-translate-y-0.5">
            ...
            <div className="hidden sm:block">
              <div className="text-[12px] font-semibold text-[var(--text-strong)]">John Doe</div>
            </div>
